...
const Danse = () => {
  ...
  return (
    <section className="danse-container">
      <h1>Performances de Danse</h1>
      <div className="subtitle">Votez pour votre chorégraphie préférée</div>
      ...
      {/* "Verdict final" (section 8.3) : classement en direct, strictement scopé à Danse —
          category="DANSE" filtre la liste reçue et recalcule le pourcentage localement
          (voir le commentaire détaillé dans RankingChart.jsx). */}
      <RankingChart category="DANSE" title="Verdict final — Danse" showExplanation />
      ...
      {selectedImage && (
        <div className="image-popup-overlay" onClick={closeImagePopup}>
          <div className="image-popup-content" onClick={e => e.stopPropagation()}>
            ...
            <p className="popup-title">{selectedImage.name}</p>
            <p className="popup-subtitle">Performance de danse</p>
          </div>
        </div>
      )}
