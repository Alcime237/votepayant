...
const JokerChant = () => {
  ...
  const fetchCandidates = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/joker-chant`);
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // Enregistrer le vote
      await axios.post(`${API_BASE_URL}/joker-chant/vote`, {
  ...
  const openImagePopup = (candidate) => {
    setSelectedImage({
      url: `${API_BASE_URL}/joker-chant/photo/${candidate.id}`,
      name: candidate.nomJokerChant
    });
      ...
      <div className="candidates-list">
        {candidates.map((candidate) => (
          <div key={candidate.id} className="candidate-card">
            ...
            >
              <img
                src={`${API_BASE_URL}/joker-chant/photo/${candidate.id}`}
                alt={candidate.nomJokerChant}
        ...
        <div className="payment-modal-overlay">
          <div className="payment-modal-content compact">
            ...
            <div className="modal-header">
              <h3>Voter pour {selectedCandidate.nomJokerChant}</h3>
              <button
